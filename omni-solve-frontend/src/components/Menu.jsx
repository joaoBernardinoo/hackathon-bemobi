  ...
  return (
    <div className={styles.sidebar}>
      ...
      <div className={styles.menu}>
        ...
        <div 
          className={`${styles.menuItem} ${selectedOption === 'Opção 1' ? styles.selected : ''}`} 
          onClick={() => handleOptionClick('Opção 1')}
        >
          <Image src="/primeiro.png" alt="Logo Opção 1" width={32} height={32} />
        </div>
        <div 
          className={`${styles.menuItem} ${selectedOption === 'Opção 2' ? styles.selected : ''}`} 
          onClick={() => handleOptionClick('Opção 2')}
        >
          <Image src="/segundo.png" alt="Logo Opção 2" width={32} height={32} />
        </div>
        <div 
          className={`${styles.menuItem} ${selectedOption === 'Opção 3' ? styles.selected : ''}`} 
