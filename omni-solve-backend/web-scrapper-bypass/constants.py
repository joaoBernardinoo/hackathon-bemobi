...
COMPLAIN_INTERACTION_LIST_SELECTOR = 'div[data-testid="complaint-interaction-list"]'
COMPLAIN_INTERACTION_SELECTOR = 'div[data-testid="complaint-interaction"]'
COMPLAIN_INTERACTION_TITLE_SELECTOR = 'h2' 
COMPLAIN_INTERACTION_CONTENT_SELECTOR = 'p' 
...
CSV_FILE_HEADERS = ['url', 'titulo', 'texto', 'status', 'local', 'data_hora',
                    'problem_type', 'product_type', 'category', 'resposta_empresa', 'replica_usuario']
